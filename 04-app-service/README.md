...
| Recurso | Tipo | Nivel | Duración | Coste |
|---|---|---|---|---|
| `demodeby-ezos89bk8plofu0` | Aplicación web | F1 | Python 3.14 | 0 € |
| `ASP-demoappservice-9852` | Plan de Servicio de Aplicaciones | Gratis | Linux | 0 € |
